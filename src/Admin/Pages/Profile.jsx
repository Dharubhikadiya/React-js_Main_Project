                    ...
                    <div className="col-xl-4">
                        <div className="card">
                            <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                ...
                                <h2 className='mb-2'>Dharmi Bhikadiya</h2>
                                ...
                                <div className="tab-content pt-2">
                                    <div className="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-9 col-md-8">Dharmi Bhikadiya</div>
                                        </div>
                                        <div className="row">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-9 col-md-8">Utran,Mota Varachha,surat</div>
                                        </div>
                                        <div className="row">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-9 col-md-8">d@gmail.com</div>
                                        </div>
                                    </div>
